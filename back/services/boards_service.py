...
from api_models import Dashboard, TypeStats, AuthData
...
class BoardService:
    ...
    This implementation relies on denormalized TeamDashboardDocument records
    maintained by TaskService when tasks are claimed and submissions are processed.
    """
